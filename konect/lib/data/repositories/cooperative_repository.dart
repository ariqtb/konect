...
class CooperativeRepository {
  final List<CooperativeItem> _items = [
    const CooperativeItem(
      ...
      imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBVxvniUOji38kOIG4Npc4QF4zEOBHUZPvXYDcoVm8xK7jL7BV_kb37zCNEXr4FBGgm0p5wIgS3553UlS3qZzTVCcO6BSlwp7e_vfoNpVKX4Tyx1yXqK4LIqHFbMcF5FdqDUbESqU3a8KI655wE_0PDXLJCIw2Esp-pel-BeaagBEB9TFYvikAJwF9EWSy4QbTobfbIeaykuIBaUTK4O5eQYuz50gQD_XsgLfPF7ye76wcvNRnQKOiGfA',
    ),
    const CooperativeItem(
      id: 'c2',
      ...
      distance: '200m dari lokasimu',
      imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCtwGspzX5_VMi9TppI6XUTSgvaLbMV5j4X535CO3q0u0ixOFuZx-pjJZwqZmAUvLuyb8skxv9HHWSF1fTyFVPZd8moQu9Qm08xLGiRuggTBDdLUVahTyGpFh6nHoug8QEyBlHlXtz9PfQ5sz20aZPK86fmEq5hjJX0WbV0SebikSQu1EgHlnyotlRJX5pqk71c0EQ9XsSI8TwljnPIou52n_pZryDobOZVqqjDSg-eoNYDfdgyj5AbBQ',
    ),
    const CooperativeItem(
      id: 'c3',
      ...
      imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA5VsV41stvFDtKwGpSKPfQeFnRKOOJeIZM-3Yy4Ay4z116mh_n2lGz_nkrh3i11N3Hz2nGolZfCY-ahnIIJ0gFsTZgUdVHF1y4IUDB7iZoXkKRAZd8m1TJ31dE7Ip5toZQf5hoSi4jDwCva0er9_EiTms9FWSFtMYdSMOFbjkLgRn_pKL6yDdMfAnubOtlfYEkJVXx3Z1atewMVUQhrvnm_ZTa2taY2s--2pIHMQYnBx0nmAvCrn7Hbw',
    ),
    const CooperativeItem(
      id: 'c4',
      ...
      imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCyc41LM7xFYpceJLbO5Em-PRi7Nmz7X0oxLYCSmiG3fQzrcdnCFrZf7PK-1uw1jT1oEGevgKNvV2C1I2H98FZWjNVb-bT3dJNULzFVXNeXkIiRKUJG_CpEBeCU8zmuaMNonibl_G43QedIvQ9eeCOQ1e6xeGBo-b24XYvmvuQU1NIwEWHcK1Yr4R-gVMbs4BeEumzJZIwgY_ntdNz0mye6uW6at-wPH_C5Oz6idQA19ZToTD-_XtLI5g',
    ),
  ];
    ...
    return CooperativeDetail(
      ...
      rooms: [
        const CoopDiscussionRoom(
          ...
          description: 'Mendiskusikan pemilihan varietas bibit unggul untuk musim tanam mendatang dan koordinasi distribusi bantuan pupuk dari pemda.',
          status: 'Aktif',
          date: '24 Okt 2023',
          membersCount: 45,
          avatars: [
        ...
        const CoopDiscussionRoom(
          ...
          description: 'Laporan transparansi keuangan dan pembagian Sisa Hasil Usaha (SHU).',
          status: 'Selesai',
          date: 'Sep 2023',
          membersCount: 30,
          avatars: [],
        ...
        const CoopDiscussionRoom(
          ...
          description: 'Kesepakatan pembelian traktor tangan kolektif untuk kelompok tani.',
          status: 'Selesai',
          date: 'Agu 2023',
          membersCount: 25,
          avatars: [],
      ...
      updates: [
        const CoopTimelineUpdate(
          ...
          description: 'Sebanyak 40 titik di Dusun Krajan telah selesai dipasang dudukan beton.',
        ...
        const CoopTimelineUpdate(
          ...
          description: 'Verifikasi unit sensor tanah dan kelembaban udara oleh tim teknis desa.',
